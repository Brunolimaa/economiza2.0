        ...
        <div class="right_col" role="main">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Atualizar lista</h4>
                        </div>
                        ...
                        <div class="modal-footer">
                            <input type="hidden" id="id_mercado"/>
                            <button type="button" class="btn btn-success" id="salvar_listaApp" data-toggle="modal" data-target="#excelModal" data-dismiss="modal">Salvar</button>
            ...
            <div class="x_content">
                ...
                <div class="alert alert-danger" style="text-align: center;">
                    <strong>Atencao!</strong> Lista na fila para conferencia.&nbsp&nbsp<i class="glyphicon glyphicon-warning-sign	Try it
"></i>
                </div>
                    ...
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        foreach($mercadoApp as $mercado) {
                            ...
                            <tr>
                                ...
                                <td><?= "<a href='#' data-toggle='modal' data-target='#avisoModal' onclick='atualizaListaApp($id)'>Atualizar</a>"; ?>
                                </td>
