...
<div class="x_panel container">
    ...
    <div class="row">
        ...
        <form class="form-horizontal form-label-left col-md-12" action="login">
            <!-- E-mail -->
            ...
            <div class="form-group col-md-6">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <input type="text" class="form-control" name="telefone" data-inputmask="'mask' : '(99) 99999-9999'">
            ...
            <div class="form-group col-md-6">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <input type="text" class="form-control" name="cnpj" data-inputmask="'mask' : '99.999.999/9999-99'">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 col-sm-9 col-xs-9">
                    <input type="text" name="cep" class="form-control" data-inputmask="'mask': '99999-999'">
                    <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                </div>
            </div>
            <!--Cidade -->
