                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php URL?>painel">Dashboard</a></li>
                                    <li><a href="<?php URL?>painel/promocao">Promocao</a></li>
                                    <li><a href="<?php URL?>painel/lixo">Recuperar Lista</a></li>
                ...
                <form id="demo-form2" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-2 col-xs-8">
                            ...
                            <div id="remove_data" style="width: 13px; display:none;"><input type="checkbox"  id="validade_checked" >Desmarcar</div>
                            <div id="data_validade" ><input type="checkbox" id="validade_checked"  style="width: 13px;"> Data (Definir p/ todos os produtos.)</div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            ...
                            <input type="button" data-toggle="modall" data-target="#avisoModall" class="btn btn-default" id="salvar_lista" value="Salvar Lista"/>
                        </div>
                    </div>
                </form>
                <div>
