                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="level2.html">Dashboard</a></li>
                                    <li><a href="index.html">Dashboard2</a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="assets/images/user.png" alt="">Bruno Lima
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12">
                            <input type="text" id="produto" name="produto" required="required" placeholder="produtos" class="form-control col-md-7 col-xs-12">
                        </div>


                        <div class="col-md-2 col-sm-6 col-xs-12">
                            <input type="text" id="marca" name="marca" placeholder="marca" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <fieldset>
                                ...
                                <input type="checkbox"  value="1" id="data_validade" style="width: 13px;"> Data (Definir p/ todos os produtos.)
                        </div>
                        <div class="col-md-2 col-sm-6 col-xs-12">
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content col-md-12">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-success" id="salvar" data-dismiss="modal">Salvar</button>
