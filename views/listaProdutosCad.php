        ...
        <div class="right_col" role="main">
            <div class="x_content">
                <p class="text-muted font-13 m-b-30">
                    <input type="button" id="excluir_lista" value="Excluir Lista" class="btn btn-danger"/>
                </p>
                <table id="datatable-buttons" class="table table-striped table-bordered">
                    ...
                    <?php
                        foreach($produto as $prod){
                            echo '<tr>';
                                echo '<td>'.utf8_encode($prod['nome']).'</td>';
                                echo '<td>'.utf8_encode($prod['marca']).'</td>';
                                echo '<td>'.$prod['descricao'].'</td>';
                                echo '<td> R$ '.$prod['preco'].'</td>';
                                echo '<td>'.$prod['validade'].'</td>';
                            echo '</tr>';
                        }
                    ?>
                    </tbody>
